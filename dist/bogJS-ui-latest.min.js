...
(function (global){
global.__BROWSERIFY_META_DATA__GIT_VERSION="b59f2fe v0.3.0",global.__BROWSERIFY_META_DATA__CREATED_AT="Thu Mar 24 2016 16:51:32 GMT+0100 (CET)",global.__BROWSERIFY_META_DATA__GIT_VERSION="b59f2fe v0.3.0",global.__BROWSERIFY_META_DATA__CREATED_AT="Thu Mar 24 2016 16:51:32 GMT+0100 (CET)",window.UIManager=require("./src/ui");
...
var jQuery=require("jquery");require("./core"),require("./mouse"),require("./widget"),/*!
...
var jQuery=require("jquery");require("./widget"),/*!
...
window.$=require("jquery"),require("jquery-ui/draggable"),require("jquery-mousewheel")($),require("jquery.transit");var UIManager=function(t,e,i){var i=i||log.levels.DEBUG;log.setLevel(i),this.om=t||new ObjectManager(e),this.bg="",this.listener="",this.btn_togglePanning="",this.btn_toggleInteractive="",this._resizeFactor=50,this._iconsize=32,this.roomsize=[500,500],this._interactive=!1,this._interval=.1,this._soloed=!1,this._enableEventListener()};UIManager.prototype={start:function(){if(1==this.om.start()){var t=[this.om.roomDimensions[0]*this._resizeFactor,this.om.roomDimensions[1]*this._resizeFactor];this._setRoomSize(t),this._setListenerPosition([this.om._listenerPosition[0],this.om._listenerPosition[1]]),this._addObjects();var e=this;return this._interactive||this._disableInteractive(),$(this.btn_togglePanning).click(function(){e.om.togglePanningType(),$(this).find("img").toggle()}),$(this.btn_toggleInteractive).click(function(){e.toggleInteractive(),$(this).find("img").toggle()}),$(this.listener).mousewheel(function(t,i){var o=e._xyz2angle(e.om.getListenerOrientation());if(0>i)var s=o-5;else var s=o+5;return e._setListenerOrientation(s),$(".irt_listener").css({rotate:s}),!1}),!0}var e=this;console.log("Object manager not yet ready.. waiting..")},stop:function(){return this.om.stop(),this._removeObjects(),$(this.btn_togglePanning).unbind(),$(this.btn_toggleInteractive).unbind(),!0},toggleInteractive:function(){0==this._interactive?this._enableInteractive():1==this._interactive&&this._disableInteractive()},enableDeviceOrientation:function(){var t=this;window.DeviceOrientationEvent?window.addEventListener("deviceorientation",function(e){var i=-1*Math.round(e.alpha);t._setListenerOrientation(i),$(this.listener).css({rotate:i})},!1):log.info("Not supported on your device or browser.  Sorry.")},_enableEventListener:function(){$(this.om).on("om_newPosition",function(t,e,i){this._changeUIObjectPosition(e,[i[0],-1*i[2]])}.bind(this)),$(this.om).on("om_isActive",function(t,e,i){this._displayObject(e,i)}.bind(this))},_displayObject:function(t,e){e?$("#"+t).show():$("#"+t).hide(),log.debug("Setting state of object "+t+" to "+e)},_enableInteractive:function(){for(key in this.om.objects)$("#"+key).draggable("enable"),$("#"+key).hover(function(){$(this).css("cursor","move")});this._enableSolo(),$(this.om).off("om_newPosition"),$(this.om).off("om_isActive"),this._interactive=!0,this.om.interactive=!0},_disableInteractive:function(){for(key in this.om.objects)$("#"+key).draggable("disable"),$("#"+key).off("dblclick"),$("#"+key).hover(function(){$(this).css("cursor","auto")});this._enableEventListener(),this._interactive=!1,this.om.interactive=!1},_enableSolo:function(){var t=this;for(var e in this.om.objects)$("#"+e).dblclick(function(e,i){if(t._soloed!==e.target.id){for(var o in t.om.objects)log.debug("Muting "+o),$("#"+o).addClass("irt_object_disabled"),t.om.objects[o].setStatus(!1);$("#"+e.target.id).removeClass("irt_object_disabled"),log.debug("Unmuting "+e.target.id),t.om.objects[e.target.id].setStatus(!0),t._soloed=e.target.id}else{for(var o in t.om.objects)log.debug("Unmuting "+o),$("#"+o).removeClass("irt_object_disabled"),t.om.objects[o].setStatus(!0);t._soloed=!1}})},_addObjects:function(){for(key in this.om.objects){$(this.bg).append("<div class='irt_object' id='"+key+"'></div>"),$("#"+key).append("<p class='irt_object_title'>"+key+"</p>");var t=this.om.objects[key].getPosition();this._changeUIObjectPosition(key,[t[0],-1*t[2]]);var e=this;$("#"+key).draggable({drag:_.throttle(function(t,i){var o=[i.position.top,i.position.left],s=e._topleft2xy(o);e.om.objects[t.target.id].setPosition([s[0],0,-1*s[1]]),log.debug("Drag event position: "+o)},50)}),this.om.objects[key].getStatus()||this._displayObject(key,!1)}},_removeObjects:function(){for(key in this.om.objects)$("#"+key).remove()},_setRoomSize:function(t){$(this.bg).css({width:t[0],height:t[1]}),this.roomsize=t},_setListenerPosition:function(t){var e=this._xy2topleft(t);$(this.listener).css({top:e[0],left:e[1]}),log.info("New listener position: "+e);var i=this;$(this.listener).draggable({drag:function(t,e){var o=[e.position.top,e.position.left],s=i._topleft2xy(o);i.om.setListenerPosition(s[0],s[1],0)}})},_setListenerOrientation:function(t){var e=10*Math.sin(t*(Math.PI/180)),i=0,o=-10*Math.cos(t*(Math.PI/180));log.info("Set angle "+t+" to new listener orientation "+e+" "+i+" "+o),this.om.setListenerOrientation(e,i,o)},_changeUIObjectPosition:function(t,e){var i=this._xy2topleft(e);$("#"+t).css({top:i[0],left:i[1]}),log.debug("New position of "+t+" is: "+i+"(xy: "+e+")")},_setObjPos:function(t,e){var i=this._topleft2xy(e),o=[i[0],i[1],0];this.om.objects[t].setPostion(o)},_xy2topleft:function(t){var e=[-t[1]*this._resizeFactor+this.roomsize[1]/2,t[0]*this._resizeFactor+this.roomsize[0]/2];return e},_topleft2xy:function(t){var e=[-(this.roomsize[1]/2-t[1])/this._resizeFactor,(this.roomsize[0]/2-t[0])/this._resizeFactor];return e},_angle2xy:function(t){var e=10*Math.sin(t*(Math.PI/180)),i=-10*Math.cos(t*(Math.PI/180));return[e,i]},_xyz2angle:function(t){var e=Math.atan2(t[0],-t[2])/Math.PI*180;return e}},module.exports=UIManager;
