...
(function (global){
"use strict";global.__BROWSERIFY_META_DATA__GIT_VERSION="2cad7e1 v0.3.0",global.__BROWSERIFY_META_DATA__CREATED_AT="Mon Jul 03 2017 17:59:56 GMT+0200 (CEST)",window.UIManager=require("./src/ui");
...
$=jQuery=require("jquery"),module.exports=require("./dist/jquery-ui.js");
...
"use strict";window.$=require("jquery"),require("jquery-ui-browserify"),require("jquery-mousewheel")($),require("jquery.transit");var UIManager=function(t,i){this.om=t||new ObjectManager(i),this.bg="",this.listener="",this.btn_togglePanning="",this.btn_toggleInteractive="",this.btn_resetOrientation="",this._resizeFactor=50,this._iconsize=32,this.roomsize=[500,500],this._interactive=!1,this._interval=.1,this._soloed=!1,this._enableEventListener()};UIManager.prototype={start:function(){if(!0===this.om.start()){var t=[this.om.roomDimensions[0]*this._resizeFactor,this.om.roomDimensions[1]*this._resizeFactor];this._setRoomSize(t),this._setListenerPosition([this.om._listenerPosition[0],this.om._listenerPosition[1]]),this._addObjects();var i=this;return this._interactive||this._disableInteractive(),$(this.btn_togglePanning).click(function(){i.om.togglePanningType(),$(this).find("img").toggle()}),$(this.btn_toggleInteractive).click(function(){i.toggleInteractive(),$(this).find("img").toggle()}),$(this.btn_resetOrientation).click(function(){i.resetDeviceOrientation()}),$(this.listener).mousewheel(function(t,e){var n=i._xyz2angle(i.om.getListenerOrientation()),o=n;return o=e<0?n-5:n+5,i._setListenerOrientation(o),$(".irt_listener").css({rotate:o}),!1}),!0}var i=this;console.log("Object manager not yet ready.. waiting..")},stop:function(){return this.om.stop(),this._removeObjects(),$(this.btn_togglePanning).unbind(),$(this.btn_toggleInteractive).unbind(),!0},toggleInteractive:function(){!1===this._interactive?this._enableInteractive():!0===this._interactive&&this._disableInteractive()},enableDeviceOrientation:function(){window.DeviceOrientationEvent?(this._orientationMode="landscape",this._angle_offset=0,this.angle=0,this._last_angle=180,this._firstCallFlag=!0,this.onOrientationChange(),window.addEventListener("orientationchange",this.onOrientationChange.bind(this),!1),window.addEventListener("deviceorientation",function(t){var i=-1*Math.round(t.alpha);this.angle=(i-this._angle_offset)%360,"landscape"===this._orientationMode&&t.gamma<0&&(this.angle+=180),this._firstCallFlag&&(this.resetDeviceOrientation(),this._firstCallFlag=!1),(this._last_angle-this.angle>=3||this._last_angle-this.angle<=-3)&&(this._setListenerOrientation(this.angle),$(this.listener).css({rotate:this.angle}),this._last_angle=this.angle)}.bind(this),!1)):console.info("Not supported on your device or browser.  Sorry.")},onOrientationChange:function(){if(screen.orientation||window.orientation){var t=screen.orientation||window.orientation,i=t.angle;0===i||180===i?this._orientationMode="portrait":90!==i&&270!==i||(this._orientationMode="landscape"),console.log("Orientation changed to "+this._orientationMode)}},resetDeviceOrientation:function(){console.log("Resetting Device Orientation!"),this._angle_offset+=this.angle%360,this.angle=0,this._setListenerOrientation(this.angle),$(this.listener).css({rotate:this.angle})},_enableEventListener:function(){$(this.om).on("om_newPosition",function(t,i,e){this._changeUIObjectPosition(i,[e[0],-1*e[2]])}.bind(this)),$(this.om).on("om_isActive",function(t,i,e){this._displayObject(i,e)}.bind(this))},_displayObject:function(t,i){i?$("#"+t).show():$("#"+t).hide(),console.debug("Setting state of object "+t+" to "+i)},_enableInteractive:function(){for(var t in this.om.objects)$("#"+t).draggable("enable"),$("#"+t).hover(function(){$(this).css("cursor","move")});this._enableSolo(),$(this.om).off("om_newPosition"),$(this.om).off("om_isActive"),this._interactive=!0,this.om.interactive=!0},_disableInteractive:function(){for(var t in this.om.objects)$("#"+t).draggable("disable"),$("#"+t).off("dblclick"),$("#"+t).hover(function(){$(this).css("cursor","auto")});this._enableEventListener(),this._interactive=!1,this.om.interactive=!1},_enableSolo:function(){var t=this;for(var i in this.om.objects)$("#"+i).dblclick(function(i,e){if(t._soloed!==i.target.id){for(var n in t.om.objects)console.debug("Muting "+n),$("#"+n).addClass("irt_object_disabled"),t.om.objects[n].setStatus(!1);$("#"+i.target.id).removeClass("irt_object_disabled"),console.debug("Unmuting "+i.target.id),t.om.objects[i.target.id].setStatus(!0),t._soloed=i.target.id}else{for(var o in t.om.objects)console.debug("Unmuting "+o),$("#"+o).removeClass("irt_object_disabled"),t.om.objects[o].setStatus(!0);t._soloed=!1}})},_addObjects:function(){for(var t in this.om.objects){$(this.bg).append("<div class='irt_object' id='"+t+"'></div>"),$("#"+t).append("<p class='irt_object_title'>"+t+"</p>");var i=this.om.objects[t].getPosition();this._changeUIObjectPosition(t,[i[0],-1*i[2]]);var e=this;$("#"+t).draggable({drag:_.throttle(function(t,i){var n=[i.position.top,i.position.left],o=e._topleft2xy(n);e.om.objects[t.target.id].setPosition([o[0],0,-1*o[1]]),console.debug("Drag event position: "+n)},50)}),this.om.objects[t].getStatus()||this._displayObject(t,!1)}},_removeObjects:function(){for(var t in this.om.objects)$("#"+t).remove()},_setRoomSize:function(t){$(this.bg).css({width:t[0],height:t[1]}),this.roomsize=t},_setListenerPosition:function(t){var i=this._xy2topleft(t);$(this.listener).css({top:i[0],left:i[1]}),console.info("New listener position: "+i);var e=this;$(this.listener).draggable({drag:function(t,i){var n=[i.position.top,i.position.left],o=e._topleft2xy(n);e.om.setListenerPosition(o[0],o[1],0)}})},_setListenerOrientation:function(t){var i=10*Math.sin(t*(Math.PI/180)),e=-10*Math.cos(t*(Math.PI/180));console.info("Set angle "+t+" to new listener orientation "+i+" 0 "+e),this.om.setListenerOrientation(i,0,e)},_changeUIObjectPosition:function(t,i){var e=this._xy2topleft(i);$("#"+t).css({top:e[0],left:e[1]}),console.debug("New position of "+t+" is: "+e+"(xy: "+i+")")},_setObjPos:function(t,i){var e=this._topleft2xy(i),n=[e[0],e[1],0];this.om.objects[t].setPostion(n)},_xy2topleft:function(t){return[-t[1]*this._resizeFactor+this.roomsize[1]/2,t[0]*this._resizeFactor+this.roomsize[0]/2]},_topleft2xy:function(t){return[-(this.roomsize[1]/2-t[1])/this._resizeFactor,(this.roomsize[0]/2-t[0])/this._resizeFactor]},_angle2xy:function(t){var i=10*Math.sin(t*(Math.PI/180));return[i,-10*Math.cos(t*(Math.PI/180))]},_xyz2angle:function(t){return Math.atan2(t[0],-t[2])/Math.PI*180}},module.exports=UIManager;

},{"jquery":6,"jquery-mousewheel":2,"jquery-ui-browserify":4,"jquery.transit":5}]},{},[1])
//# sourceMappingURL=bogJS-ui-latest.min.js.map
